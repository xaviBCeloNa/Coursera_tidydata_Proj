...
run_analysis.R script will merge the test and training sets together. Prerequisites for this script:
...
Details of the README FILE listed below for reference to the data files.
